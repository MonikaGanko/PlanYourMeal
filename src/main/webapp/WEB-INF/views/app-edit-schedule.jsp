...
<header class="page-header">
    <nav class="navbar navbar-expand-lg justify-content-between">
        ...
        <div class="d-flex justify-content-around">
            <h4 class="text-light mr-3">${planToEdit.admin.firstName}</h4>
...
<div class="m-4 p-3 width-medium">
    <div class="dashboard-content border-dashed p-3 m-4 view-height">
        ...
        <form:form method="post" action="/app/plan/edit" modelAttribute="planToEdit" >
            <div class="schedules-content">
                <div class="form-group row">
                    ...
                    <form:errors path="id"/>
                    <div class="col-sm-10">
                        <form:input path="name" type="text" class="form-control" id="planName" value="${planToEdit.name}"/>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <form:textarea path="description" class="form-control" rows="5" id="planDescription" value="${planToEdit.description}"/>
