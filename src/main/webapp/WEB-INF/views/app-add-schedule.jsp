            ...
            <div class="dashboard-content border-dashed p-3 m-4 view-height">
                ...
                <div class="schedules-content">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <form:input path="name" type="text" class="form-control" id="planName" placeholder="Nazwa planu"/>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <form:textarea path="description" class="form-control" rows="5" id="planDescription" placeholder="Opis planu"/>
