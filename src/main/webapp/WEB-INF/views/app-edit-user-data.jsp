            ...
            <div class="m-4 border-dashed view-height">
                <div class="mt-4 ml-4 mr-4">
                    ...
                    <div class="row border-bottom border-3">
                        ...
                        <a class="col d-flex justify-content-end mb-2"><button type="submit" class="btn btn-color rounded-0 pt-0 pb-0 pr-4 pl-4">Zapisz</button>
                    </div>
                    ...
                    <table class="table borderless">
                        ...
                        <tr class="d-flex">
                            ...
                            <td class="col-7">
                                <form:input path = "firstName" class="w-100 p-1" value="${admin.firstName}"/>
                        ...
                        <tr class="d-flex">
                            ...
                            <td class="col-7">
                                <form:input path = "lastName" class="w-100 p-1" value="${admin.lastName}"/>
                        ...
                        <tr class="d-flex">
                            ...
                            <td class="col-3">
                                <form:input path= "email" class="p-1 w-100" type="text" value="${admin.email}"/>
